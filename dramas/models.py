...
class Drama(models.Model):
    ...
    cover = models.ImageField(_('封面'), upload_to='dramas/covers/')
...
class Episode(models.Model):
    ...
    thumbnail = models.ImageField(_('缩略图'), upload_to='dramas/thumbnails/')
...
class Actor(models.Model):
    ...
    avatar = models.ImageField(_('头像'), upload_to='dramas/actors/')
